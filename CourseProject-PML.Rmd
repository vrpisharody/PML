...
Is the error rate for the predictions for ***input data (training data)*** to the model. It is  **`r mean(modrf.pml$err.rate)`**, (***mean(modrf.pml$err.rate)***).

#####Out Of Sample Error Rate :

The expected out of sample error will be the error rate for predictions on the cross validated data provided to the model. It is **`r mean(modrf.pml$test$err.rate)`**, (***mean(modrf.pml\$test\$err.rate)***).
